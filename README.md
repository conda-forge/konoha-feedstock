...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/konoha-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11494&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/konoha-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `konoha` can be installed with:

```
conda install konoha
```

It is possible to list all of the versions of `konoha` available on your platform with:
